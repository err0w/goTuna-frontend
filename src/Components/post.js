...
function Post({item,onPressPost}){
    ...
    return(
        <View style={style.container}>
            ...
            <View style={style.upperContainer}>
                    <Text>{item.username} | {item.designation} </Text>
            ...
            <View style={style.lowerContainer}>
                <View style={style.voteSection}>
                    <View style={style.upvote}>
                        ...
                        <Text>{item.up_votes}</Text>
                    </View>
                    <View style={style.downvote}>
                    <Ionicons name='arrowdown' size={24} color="black"></Ionicons>
                    <Text>{item.down_votes}</Text>
                    </View>
                </View>
                <TouchableOpacity onPress={onPressPost} style={style.commentSection}>
